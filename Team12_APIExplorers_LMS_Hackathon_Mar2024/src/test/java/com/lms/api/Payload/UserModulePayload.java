...
public class UserModulePayload {
	    ...
	    private UserLoginUserModulePayload userLogin;
	    private String userMiddleName;
	    private Long userPhoneNumber;
	    private List<UserRoleMap_UserModulePayload> userRoleMaps;
	    ...
	    public UserLoginUserModulePayload getUserLogin() {
	        return userLogin;
	    }

	    public void setUserLogin(UserLoginUserModulePayload userLogin) {
	    ...
	    public List<UserRoleMap_UserModulePayload> getUserRoleMaps() {
	        return userRoleMaps;
	    }

	    public void setUserRoleMaps(List<UserRoleMap_UserModulePayload> userRoleMaps) {
